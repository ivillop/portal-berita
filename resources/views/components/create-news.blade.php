...
<button onclick="onShowModal('create-modal')" class="bg-green-200 hover:bg-green-300 px-4 p-1 rounded flex gap-2 items-center py-2 w-40" type="button">
...
<div id="create-modal" tabindex="-1" aria-hidden="true"
    class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 transition-opacity duration-300 ease-in-out opacity-0 pointer-events-none">
    <div class="relative w-full max-w-md max-h-full transition-transform duration-300 ease-in-out transform scale-90">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 p-4">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    onclick="onHideModal('create-modal')">
            ...
            <form {{ $attributes }}>
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text"
                            class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
